...
export default class SendSpeciesMessageModal extends Component<ISpeciesMessageModalProps, ISpeciesMessageModalState> {
    ...
    handleFieldChange(field: string, type: string = "string"): (e: any) => void {
        return (e: any) => {
    ...
    render() {
        return (
            <div class="modal fade show d-block" role="dialog" tabIndex={-1} style={{overflowY: "auto"}}>
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            {!this.state.geolocationAllowed && <div class="form-group">
                                <button class="btn btn-primary" onClick={this.getLocation}>Use Current Location
                                </button>
                            </div>}

                            <div class="form-group">
                                <label>Latitude</label>
                                <input type="number" class="form-control" disabled={this.state.geolocationAllowed}
                            ...
                            <div class="form-group">
                                <label>Species</label>
                                <input class="form-control" value={this.state.message.species}
                                       onChange={this.handleFieldChange("species")}/>
                            </div>
                            <div class="form-group">
                                <label>Temperature</label>
                                <div class="input-group">
                                    <input type="number" class="form-control" value={this.state.message.temperature}
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" value={this.state.message.abundance}
                                       onChange={this.handleFieldChange("abundance", "number")}/>
                            </div>
                            <div class="form-group">
                                <label>Content</label>
                                <input class="form-control" value={this.state.message.content}
                                       onChange={this.handleFieldChange("content")}/>
                            </div>
                            <div class="form-group">
                                <label>Image</label>
                                <input accept="image/png, image/jpeg" class="form-control-file" type="file" onChange={this.handleImageUpload}/>
                            </div>
                        </div>
