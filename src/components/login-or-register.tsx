...
export default class LoginOrRegister extends Component<ILoginOrRegisterProps, ILoginOrRegisterState> {
        ...
        return (
            <div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="username" onChange={this.onUsernameChange}/>
                </div>
                <div class="form-group">
                    <label htmlFor="password">Password</label>
                    <input type="password" class="form-control" id="password" onChange={this.onPasswordChange}/>
                </div>
                {this.state.error && <div class="alert alert-danger">
                    {this.state.error}
                </div>}
                <button class="btn btn-primary mr-1" onClick={this.register}>Register</button>
